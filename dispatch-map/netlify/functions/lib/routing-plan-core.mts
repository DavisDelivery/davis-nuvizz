...
// lib/driver-class.mts with employeeClassMap (v1.71.0) and re-exported here unchanged.
...
// employeeClassMap moved to lib/driver-class.mts (v1.71.0), unchanged, so the Claude shadow can
