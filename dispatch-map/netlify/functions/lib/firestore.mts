...
// Exported for lib/prod-catalogue.mts, the UAT seeder's read-only reader of the PRODUCTION
// database. It shares this decoder rather than growing a second copy of the value codec —
// but nothing else: that module builds its own URLs so it can never inherit a writer.
