...
function h3(e, r, n, c, i) {
  ...
  const g = `${s}|${h}|${u}`;
  if (g in e.resG) return e.resG[g];
  const x = `${s}|${h}`;
...
const p8 = 3958.8;
function x3(e, r) {
  const [n, c] = e, [i, l] = r, s = n * Math.PI / 180, h = i * Math.PI / 180, u = (i - n) * Math.PI / 180, v = (l - c) * Math.PI / 180, g = Math.sin(u / 2) ** 2 + Math.cos(s) * Math.cos(h) * Math.sin(v / 2) ** 2;
  return 2 * p8 * Math.asin(Math.sqrt(g));
}
let u3 = null, f3 = null;
function h8(e) {
  if (f3 !== e) {
...
function k3(e, { zip: r, w: n, sk: c, lo: i, distMi: l, oaPerMile: s }) {
  const h = String(r), u = e.dataRadiusMi ?? 80, v = h in e.zone5, g = h8(e).has(h.slice(0, 3));
  if (!(!v && (!g || l != null && l > u))) {
    const w = s8(e, r);
    return { tier: v ? "data" : "nearby", zb: w, lh: p3(e, w, n) + h3(e, w, c, i, n), distMi: l, oaExtra: 0, radius: u };
  }
  const f = e.zoneMin && e.zoneMin.Z3 || 71.58, b = s ?? e.oaPerMile ?? 1.75, S = l != null ? Math.max(0, l - u) : 0, z = b * S;
...
function z8(e, { zip: r, weight: n, skids: c = 1, loose: i = 0, fuelPct: l = 28, marginPct: s = 0, accessorial: h = 0, distMi: u = null }) {
  const v = Number(n) || 0, g = (Number(l) || 0) / 100, x = (Number(s) || 0) / 100, f = k3(e, { zip: r, w: v, sk: c, lo: i, distMi: u ?? u8(r) }), b = f.lh * (1 + g), S = Number(h) || 0, z = b * (1 + x);
  return { zone: j[Math.round(f.zb * 100) / 100] || "Z?", zb: f.zb, tier: f.tier, distMi: f.distMi, oaExtra: f.oaExtra, linehaul: f.lh, fuelAmt: f.lh * g, allIn: b, accessorial: S, freight: z, quoted: z + S };
}
const V8 = B;
let y = B;
const f8 = (e) => {
  const r = v3[String(e).slice(0, 5)];
  return y.origin && r ? x3(y.origin, r) : null;
}, g8 = (e, r, n, c) => k3(y, { zip: e, w: r, sk: n, lo: c, distMi: f8(e) });
function b8(e, r, n, c, i) {
...
`;
function b3({ value: e, set: r, min: n = 0 }) {
...
function q8({ accentHex: e }) {
  ...
  return /* @__PURE__ */ t("svg", { viewBox: `0 0 ${c} ${i}`, style: { display: "block", width: "100%", height: "auto" }, role: "img", "aria-label": "Minimum charge by zone", children: r.map(([h, u], v) => {
    const g = (i - 30) * (u / n), x = s + v * (l + s), f = i - 20 - g;
    return /* @__PURE__ */ o("g", { children: [
      /* @__PURE__ */ t("rect", { x, y: f, width: l, height: g, rx: "5", fill: e, opacity: "0.88" }),
...
function y8({ profiles: e, profileId: r, marginPct: n, curProfile: c, showAdd: i, newName: l, newMk: s, selectProfile: h, saveProfile: u, deleteProfile: v, setShowAdd: g, setNewName: x, setNewMk: f }) {
  return /* @__PURE__ */ o(U, { full: !0, label: "Customer profile", hint: "Applies a saved markup or discount", children: [
    /* @__PURE__ */ o("select", { className: "rc-select", value: r, onChange: (b) => h(b.target.value), children: [
      e.map((b) => /* @__PURE__ */ o("option", { value: b.id, children: [
        b.name,
    ...
    i && /* @__PURE__ */ o("div", { className: "rc-addbox", children: [
      /* @__PURE__ */ t("input", { className: "rc-input nm", placeholder: "Customer name", value: l, onChange: (b) => x(b.target.value) }),
      /* @__PURE__ */ t("input", { className: "rc-input mk", inputMode: "decimal", placeholder: "%", value: s, onChange: (b) => f(b.target.value.replace(/[^0-9.\-]/g, "")) }),
...
function S8({ name: e, info: r, rateRow: n }) {
  const [c, i] = m(!1);
...
function w8() {
  return /* @__PURE__ */ o("div", { className: "rc-card", children: [
    ...
    /* @__PURE__ */ t("div", { className: "rc-tblwrap", children: /* @__PURE__ */ o("table", { className: "rc-tbl", children: [
      ...
      /* @__PURE__ */ t("tbody", { children: y.breaks.map((e) => /* @__PURE__ */ o("tr", { children: [
        /* @__PURE__ */ t("td", { className: "brk", children: e }),
        ["Z1", "Z2", "Z3", "Z4"].map((r) => /* @__PURE__ */ o("td", { className: y.estCells[r].includes(e) ? "est" : "", children: [
          "$",
          A(y.rateSheet[r][e])
        ] }, r))
      ] }, e)) })
...
function K8({ model: e, modelUrl: r, initialZip: n, initialWeight: c, initialSkids: i, initialLoose: l, embedded: s } = {}) {
  const [h] = m("blue"), [u, v] = m("quote"), [g, x] = m(n != null ? String(n).replace(/[^0-9]/g, "").slice(0, 5) : "30127"), [f, b] = m(c != null ? String(Math.max(0, Math.round(Number(c) || 0))) : "1330"), [S, z] = m(i != null ? Number(i) : 3), [w, N3] = m(l != null ? Number(l) : 0), [V, X] = m("28"), [Z, Q] = m("0"), [O, q3] = m({ sameday: !1, residential: !1, liftgate: !1 }), [K, G] = m(m3), [C, W] = m("list"), [y3, M] = m(!1), [Y, $] = m(""), [_, e3] = m(""), [r3, t3] = m(0);
  R(() => {
    if (e && e.zone5) {
      y = e, t3((a) => a + 1);
      return;
  ...
  const a3 = async (a) => {
    ...
    const a = Y.trim();
    if (!a) return;
    const p = Number(_) || 0, N = "p" + Date.now(), q = [...K, { id: N, name: a, markup: p }];
    a3(q), W(N), Q(String(p)), M(!1), $(""), e3("");
  }, A3 = () => {
    ...
    const a = Number(f) || 0, p = (Number(V) || 0) / 100, N = (Number(Z) || 0) / 100, q = g8(g, a, S, w), T = q.lh * (1 + p), H = T * (1 + N), l3 = F.reduce((Z3, s3) => Z3 + (O[s3.key] ? s3.amount : 0), 0), P3 = H + l3, J3 = Math.max(S + w, 1);
    return { zb: q.zb, lh: q.lh, fuelAmt: q.lh * p, allIn: T, freight: H, accAmt: l3, quoted: P3, marginAmt: H - T, tier: q.tier, distMi: q.distMi, oaExtra: q.oaExtra, radius: q.radius, conf: b8(q.tier, J3, a, w, q.distMi) };
  }, [g, f, S, w, V, Z, r3, O]), n3 = Q3(null);
  R(() => {
    const a = n3.current;
    a && (a.classList.remove("rc-anim"), a.offsetWidth, a.classList.add("rc-anim"));
  }, [d.quoted]);
  const o3 = Number(V) || 0, k = Number(Z) || 0, c3 = k === 0 ? "" : k > 0 ? `+${k}% margin` : `${k}% discount`, P = K.find((a) => a.id === C), z3 = P && P.id !== "list" && P.id !== "__custom__" ? " · " + P.name : "", V3 = `${k === 0 ? "all-in" : "quote"} · ${o3}% fuel${c3 ? " · " + c3 : ""}${z3}`, i3 = d.conf.key === "core" ? "ok" : d.conf.key === "est" || d.conf.key === "oa" ? "warn" : "", K3 = d3(() => d8(y), [r3]), O3 = { "--accent": g3[h], "--accent-d": m8[h], "--accent-ring": v8[h] };
    ...
    /* @__PURE__ */ o("div", { className: "rc-wrap", children: [
      ...
      u === "quote" && /* @__PURE__ */ o(D, { children: [
        ...
        /* @__PURE__ */ o("div", { className: "rc-hero", children: [
          ...
          /* @__PURE__ */ o("div", { className: "rc-hstatus", children: [
            ...
            /* @__PURE__ */ t("span", { className: "rc-hpill", children: String(g).slice(0, 5) || "—" })
          ] })
        ] }),
        /* @__PURE__ */ o("div", { className: "rc-card", children: [
          ...
          /* @__PURE__ */ o("div", { className: "rc-form", children: [
            ...
            /* @__PURE__ */ t(U, { label: "Destination ZIP", hint: "Sets the rate zone", children: /* @__PURE__ */ t("input", { className: "rc-input", inputMode: "numeric", maxLength: 5, value: g, onChange: (a) => x(a.target.value.replace(/[^0-9]/g, "").slice(0, 5)) }) }),
            /* @__PURE__ */ t(U, { label: "Weight", hint: "Total pounds", children: /* @__PURE__ */ t("input", { className: "rc-input", inputMode: "numeric", value: f, onChange: (a) => b(a.target.value.replace(/[^0-9]/g, "")) }) }),
            /* @__PURE__ */ t(U, { label: "Skids", hint: "Pallet count", children: /* @__PURE__ */ t(b3, { value: S, set: z, min: 0 }) }),
            /* @__PURE__ */ t(U, { label: "Loose pieces", hint: "Non-palletized", children: /* @__PURE__ */ t(b3, { value: w, set: N3, min: 0 }) }),
            ...
            /* @__PURE__ */ t(U, { full: !0, label: "Accessorials", hint: "Flat fees added to the quote", children: /* @__PURE__ */ t("div", { className: "rc-accs", children: F.map((a) => /* @__PURE__ */ o("button", { className: "rc-acc" + (O[a.key] ? " on" : ""), onClick: () => q3((p) => ({ ...p, [a.key]: !p[a.key] })), "aria-pressed": !!O[a.key], children: [
              a.label,
              " ",
      ...
      u === "zones" && /* @__PURE__ */ o(D, { children: [
        /* @__PURE__ */ o("div", { className: "rc-card", children: [
          ...
          /* @__PURE__ */ t("div", { className: "rc-tblwrap", children: /* @__PURE__ */ t(q8, { accentHex: g3[h] }) })
        ] }),
        /* @__PURE__ */ t("div", { className: "rc-zwrap", children: ["Z1", "Z2", "Z3", "Z4"].map((a) => /* @__PURE__ */ t(S8, { name: a, info: K3[a], rateRow: y.rateSheet[a] }, a)) })
      ] }),
